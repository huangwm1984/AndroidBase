...
//            "http://dlsw.baidu.com/sw-search-sp/soft/94/23191/BaiduWubiSetup-1_2_0_13.1401780898.exe",
    ...
    private String saveDir = Environment.getExternalStorageDirectory() + "/AndroidTest/download/";;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_download_main);
        ...
        for (int i = 0; i < btnStarts.length; i++) {
            ...
            btnStarts[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    DLManager.getInstance(DownLoadActivity.this).dlStart(URLS[finalI], saveDir,
                            new DLTaskListener() {
                                @Override
        ...
        for (int i = 0; i < btnStops.length; i++) {
            ...
            btnStops[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DLManager.getInstance(DownLoadActivity.this).dlStop(URLS[finalI]);
                }
            });
        }
        ...
        for (int i = 0; i < btnNotifys.length; i++) {
            ...
            btnNotifys[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    NotificationUtil.notificationForDLAPK(DownLoadActivity.this, URLS[finalI]);
                }
            });
        }
