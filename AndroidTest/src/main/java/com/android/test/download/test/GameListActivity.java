package com.android.test.download.test;
...
import com.android.test.download.test.adapter.GameAdapter;
import com.android.test.download.test.data.GameDataManager;
